...
<body>
  ...
  <!-- Main Content -->
  <section class="Container Best-Manga" id="bestbanga">
    <h2 class="Title One">POPULAR THIS WEEK</h2>
    <div class="Container-MainManga">
      <img class="Banner" src="https://mangakatana.com/imgs/cover/09c/20/2762f-l.jpg" alt="kaoru to hana">
     ...
     <section class="Container Catalogue" id="catalogue">
       ...
       <div class="Container-Manga Shonen">
         <div class="card" style="--i:url(https://infoliteraria.com/wp-content/uploads/2021/05/Dandadan.jpg.webp)">
           <div class="content">
             <h3>DanDaDan</h3>
             <h4>8$</h4>
    ...
    <div class="Container-Letters">
         ...
         <div class="card" style="--i:url( https://i.pinimg.com/474x/bf/ce/31/bfce319447e621ac8a0490f926ccd106.jpg)">
           <div class="content">
      ...
      <!--Thiller Section -->
      <div class="Container-Letters">
         <h3 class="Subtitle For">The Thriller Manga, which will leave you stunned.</h3>    
       </div>
       <div class="Container-Manga Thriller">
         ...
         <div class="card" style="--i:url(https://otakuteca.com/images/books/cover/5dba083baa33b.jpg)">
           <div class="content">
             <h3>Inside Mari</h3>
             <h4>7.5$</h4>
             <a class="a-1" href="#">Read</a>
         ...
         <div class="card" style="--i:url(https://otakuteca.com/images/books/cover/5dba13f5a9d7e.jpg)">
           <div class="content">
             <h3>Monster</h3>
             <h4>9$</h4>
             <a class="a-1" href="#">Read</a>
